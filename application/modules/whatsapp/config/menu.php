<?php 
if (file_exists(APPPATH.'modules/whatsapp/assets/data/env'))
...
<li class="treeview active">
                    ...
                    <a href="javascript:void(0)">
                      ...
                      <span class="badge badge-inline badge-danger pull-right" style="margin-right: 24px;background-color: #ff0000; color:#ffffff !important;">Addon</span>
