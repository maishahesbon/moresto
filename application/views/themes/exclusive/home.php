<!--START HERO PART -->
<div class="bg-dark-green position-relative">
    <div class="sect_pad position-relative">
        <div class="container">
            <div class="row g-4 g-xl-5 align-items-center justify-content-between">
                <div class="col-xl-5 col-lg-6">
                    <h1 class="main_title text-white mb-4 mb-lg-5" data-aos="fade-down" data-aos-delay="100">
                        <?php echo (!empty($hero_title->widget_desc) ? $hero_title->widget_desc : 'Delicious food & wonderful eating experience'); ?>
                    </h1>
                    <p class="mb-4 mb-lg-5 text-white" data-aos="fade-down" data-aos-delay="200">
                        <?php echo (!empty($hero_sub_title->widget_desc) ? $hero_sub_title->widget_desc : 'Discover bold flavors and unforgettable dishes in a place where every craving is satisfied with the perfect bite, crafted just for you.'); ?>
                    </p>
                    <div class="d-flex flex-wrap align-items-center gap-3" data-aos="fade-down" data-aos-delay="200">
                        <a href="<?php echo base_url('reservation'); ?>" class="btn btn_primary w-sm-100"><?php echo display('reservation') ?></a>
                        <a href="<?php echo base_url('menu'); ?>" class="btn btn_primary_outline text-white w-sm-100"><?php echo display('open_menu') ?></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="position-relative align-items-center d-flex justify-content-center text-center" data-aos="zoom-in">
                        <?php
                        if (!empty($hero_video_link->widget_desc)) { ?>
                            <a href="<?php echo $hero_video_link->widget_desc; ?>" target="_blank" class="btn btn-circle btn-video bg_primary position-absolute">
                                <svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M20.582 11.2679C21.9154 12.0377 21.9154 13.9622 20.582 14.732L3.2089 24.7624C1.87556 25.5322 0.208895 24.57 0.208896 23.0304L0.208896 2.96962C0.208896 1.43001 1.87556 0.467762 3.2089 1.23756L20.582 11.2679Z" fill="white" />
                                </svg>
                            </a>
                        <?php } ?>
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img class="img-fluid h-250 rounded-3 mb-3" src="<?php echo base_url(!empty($hero_images[2]->image) ? $hero_images[2]->image : 'dummyimage/300x250.png'); ?>" alt="img" />
                                <img class="img-fluid h-250 rounded-3" src="<?php echo base_url(!empty($hero_images[1]->image) ? $hero_images[1]->image : 'dummyimage/300x250.png'); ?>" alt="img" />
                            </div>
                            <div class="col-lg-6">
                                <img class="img-fluid h-100 rounded-3" src="<?php echo base_url(!empty($hero_images[0]->image) ? $hero_images[0]->image : 'dummyimage/324x516.png'); ?>" alt="img" />
                            </div>
                        </div>
                    </div>
                </div>
...
if (!empty($welcome_text)) { ?>
    <section class="sect_pad">
        <div class="container">
            <div class="row g-4 g-lg-5 justify-content-center align-items-center mb-4 mb-lg-5">
                <div class="col-xl-8 col-md-10 text-center">
                    <p class="font_prata fs-20 text_primary" data-aos="fade-down" data-aos-delay="100"><?php echo $welcome_text->widget_title; ?></p>
                    <h2 class="sec_title mb-4" data-aos="fade-down" data-aos-delay="150"><?php echo $welcome_text->widget_name; ?></h2>
                    <p class="fs-16" data-aos="fade-down" data-aos-delay="200"><?php echo $welcome_text->widget_desc; ?></p>
                </div>
            </div>
                ...
                <?php if (!empty($service_list)) {
                    foreach ($service_list as $index => $service) { ?>
                        <div class="col-md-6 col-xl-3 text-center" 
                            data-aos="fade-down" 
                            data-aos-delay="<?php echo 100 + ($index * 50); ?>">
                            
                            <img class="img-fluid mb-4" 
                                src="<?php echo base_url(
                                    !empty($service->image) 
                                    ? $service->image 
                                    : 'application/views/themes/' . $theme_name . '/assets_web/images/icon/icon-' . ($index + 1) . '.png'
                                ); ?>" 
                                alt="icon" />

                            <h3 class="mb-2"><?php echo $service->title; ?></h3>
                            <p class="mb-0"><?php echo $service->subtitle; ?></p>
                        </div>
                <?php }
                } ?>
            </div>
            <div class="d-flex flex-wrap justify-content-center align-items-center gap-3 pt-3" data-aos="fade-down" data-aos-delay="200">
...
<!-- Start Specials Food Menu slider  -->
<?php if (!empty($special)) { ?>
    <section class="sect_pad position-relative bg_soft_primary">
        <div class="container-fluid overflow-hidden">
            <div class="row g-4 g-lg-5 justify-content-center align-items-center mb-5">
                <div class="col-xl-7 col-md-10 text-center">
                    <p class="font_prata fs-20 text_primary" data-aos="fade-down" data-aos-delay="100"><?php echo $special->widget_name; ?></p>
                    <h2 class="main_title" data-aos="fade-down" data-aos-delay="150"><?php echo $special->widget_title; ?></h2>
                </div>
            </div>
            <div class="row justify-content-center g-4 position-relative mb-5" data-aos="zoom-in">
                <div class="col-md-12">
                    <div class="owl-carousel menu-carousel owl-theme">
                        <?php 
                        foreach ($special_menu as $special_food) { ?>
                            <div class="card p-2 rounded-4">
                                <div class="menu-slider-img">
                                    <img class="img-fluid rounded-4" src="<?php echo base_url(!empty($special_food->ProductImage) ? $special_food->ProductImage : 'dummyimage/253x263.jpg'); ?>" alt="<?php echo $special_food->ProductName ?>" />
                                </div>
                                <div class="px-2 mb-3">
                                    <h4 class="mb-2 fs-22"><?php echo $special_food->ProductName ?>(<?php echo $special_food->variantName ?>)</h4>
                                    <p>
                                        <?php 
                                        $desc = strip_tags($special_food->descrip);
                                        echo strlen($desc) > 120 ? substr($desc, 0, 120) . '...' : $desc;
                                        ?>
                                    </p>
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-2 font_prata">
                                            <span class="fs-16 text_primary"><?php echo display('price')?> :</span>
                                            <span class="fs-16 text_primary">
                                                <?php if ($this->storecurrency->position == 1) { echo $this->storecurrency->curr_icon; } ?>
                                                <?php echo number_format($special_food->price, 2); ?>
                                                <?php if ($this->storecurrency->position == 2) {echo $this->storecurrency->curr_icon;} ?>
                                            </span>
                                        </div>
                                        <a class="cart-button" href="<?php echo base_url() . 'details/' . $special_food->ProductsID . '/' . $special_food->variantid; ?>">
                                            <?php echo display('cart')?>
            ...
            <div class="row g-4 g-lg-5 justify-content-center align-items-center" data-aos="zoom-in">
                <div class="col-xl-7 col-md-10 text-center" data-aos="fade-down">
                    <h2 class="sec_title mb-4"><?php echo strip_tags($special->widget_desc); ?></h2>
                    <a href="<?php echo base_url('menu'); ?>" class="btn btn_primary"><?php echo display('view_full_menu') ?></a>
                </div>
            </div>
        </div>
    </section>
<?php } ?>
<!-- End Specials Food Menu slider  -->
...
<!-- Start Food Menu  -->
<section class="sect_pad position-relative bg-dark-green">
    <div class="container">
        <div class="row g-4 g-lg-5 justify-content-center align-items-center mb-5">
            <div class="col-xl-8 col-md-10 text-center">
                <p class="font_prata fs-20 text_primary" data-aos="fade-down" data-aos-delay="100"><?php echo $testymenu->widget_name; ?></p>
                <h2 class="main_title text-white" data-aos="fade-down" data-aos-delay="150"><?php echo $testymenu->widget_title; ?></h2>
            </div>
        </div>

        <div class="row g-4 g-md-5 food-menu text-white">
            <?php
            // Step 1: Fetch active menu types
            $menutypes = $this->db
                ->select('menutypeid, menutype')
                ->from('tbl_menutype')
                ->where('status', 1)
                ->get()
                ->result();

            // Step 2: Prepare menu types that actually have foods
            $menutypes_with_foods = [];
            foreach ($menutypes as $menutype) {
                $condition = "FIND_IN_SET('" . $menutype->menutypeid . "', item_foods.menutype) AND item_foods.ProductsIsActive=1";
                ...
                $foods = $this->db
                    ->select('item_foods.*, variant.price')
                    ->from('item_foods')
                    ->join('variant', 'variant.menuid = item_foods.ProductsID', 'left')
                    ->where($condition)
                    ->group_by('item_foods.ProductsID, variant.menuid')
                    ->get()
                    ->result();

                if (!empty($foods)) {
                    $menutype->foods = $foods;
                    $menutypes_with_foods[] = $menutype;
                }
            }

            // Step 3: Chunk menu types into groups of 3 for each column
            $columns = array_chunk($menutypes_with_foods, 3);
            ?>
   
            <?php foreach ($columns as $index => $column): ?>
                <div class="col-md-6 col-xl-4" data-aos="fade-down" data-aos-delay="<?php echo 100 + ($index * 50) ?>">
                    <?php foreach ($column as $menutype): ?>
                        <div class="menu-item">
                            <h3 class="food-title"><?php echo $menutype->menutype ?></h3>
                            <div class="food-item">
                                <?php foreach ($menutype->foods as $food): ?>
                                    <div class="dot-fill">
                                        <span class="food-description"><?php echo $food->ProductName ?></span>
                                        <span class="dots"></span>
                                        <span class="food-price">
                                            <?php if ($this->storecurrency->position == 1) { echo $this->storecurrency->curr_icon; } ?>
                                            <?php echo number_format($food->price ?? 0, 2); ?>
                                            <?php if ($this->storecurrency->position == 2) {echo $this->storecurrency->curr_icon;} ?>
                                        </span>
                                    </div>
                                <?php endforeach; ?>
...
<?php if (!empty($testimonial_title)) { ?>
    <section class="sect_pad bg-dark-green">
        <div class="container">
            <div class="row g-4 g-lg-5 justify-content-center align-items-center mb-5">
                <div class="col-xl-8 col-md-10 text-center">
                    <p class="font_prata fs-20 text_primary" data-aos="fade-down" data-aos-delay="100"><?php echo $testimonial_title->widget_name; ?></p>
                    <h2 class="main_title text-white" data-aos="fade-down" data-aos-delay="150"><?php echo $testimonial_title->widget_title; ?></h2>
                </div>
            </div>
                            ...
                            <div class="testimonial-card">
                                <div class="testimonial-content">
                                    <div class="testimonial-profile">
                                        <img src="<?php echo base_url(!empty($testimonial->image) ? $testimonial->image : 'dummyimage/60x60.jpg'); ?>" alt="" />
                                    </div>
                                    <span class="testimonial-text">“<?php echo $testimonial->subtitle; ?>”</span>
                               
                                    <?php $rating = (int)($testimonial->slink ?? 4); $max    = 5; ?>
                                    <div class="d-flex justify-content-center align-items-center gap-2 mt-3" aria-label="Rating: <?php echo $rating; ?> out of <?php echo $max; ?>">
                                        <?php for ($i = 1; $i <= $max; $i++): ?>
                                            <?php if ($i <= $rating): ?>
                                                <!-- Filled star -->
                                                <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11.09 14.5716L16.3044 17.7188L14.9207 11.7872L19.5275 7.79625L13.461 7.28156L11.09 1.6875L8.71909 7.28156L2.65253 7.79625L7.2594 11.7872L5.87565 17.7188L11.09 14.5716Z" fill="#FFB632"/>
                                                </svg>
                                            <?php else: ?>
                                                <!-- Outline star -->
                                                <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11.09 14.5716L16.3044 17.7188L14.9207 11.7872L19.5275 7.79625L13.461 7.28156L11.09 1.6875L8.71909 7.28156L2.65253 7.79625L7.2594 11.7872L5.87565 17.7188L11.09 14.5716Z"
                                                        fill="none" stroke="#FFB632" stroke-width="1.5" stroke-linejoin="round"/>
                                                </svg>
                                            <?php endif; ?>
                                        <?php endfor; ?>
                                    </div>           
                                    <div class="testimonial-name mt-3"><?php echo $testimonial->title; ?></div>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
