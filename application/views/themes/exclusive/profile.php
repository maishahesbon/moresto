...
<link href="<?php echo base_url('application/views/themes/' . $acthemename . '/assets_web/css/profile.css') ?>" rel="stylesheet" type="text/css"/>
 <div class="modal fade" id="updatep" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header ps-3 py-1">
                <h1 class="modal-title fs-5" id="exampleModalLabel"><?php echo display('update')?></h5>
                 ...
                 <div class="col-sm-12 col-md-12 rating-block myinfotable">
                     ...
                     <table class="table table-hover" width="100%">
                         <tbody>
                             <tr>
                                <th>
                                    <a class="btn btn-success btn-sm search profile_fff" data-bs-toggle="modal" data-bs-target="#updatep" data-bs-dismiss="modal"><strong><?php echo display('profile_update') ?></strong></a>
                                </th>
                                 <td></td>
                             </tr>
                             <tr>
