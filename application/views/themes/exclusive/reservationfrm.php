...
<?php echo form_open('hungry/bookreservation',array('id'=>'reservesubmit')) ?>
    ...
    <div class="form-group row bookinfo">
        <label for="selecttable" class="col-sm-4 col-form-label"><?php echo "Table Name."; ?>*</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row bookinfo">
        <label for="booktime" class="col-sm-4 col-form-label"><?php echo display('s_time') ?> *</label>
        <div class="col-sm-8">
            <?php echo $gettime;?>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-8">
            <input name="bookendtime" id="reservation_time" class="form-control" type="time" placeholder="<?php echo display('e_time') ?>" value="<?php echo $endtime;?>">
        </div>
    </div>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-8">
            <input type="text" name="customer_name" class="form-control" id="name" placeholder="John Doe" value="<?php echo (!empty($customerinfo->customer_name)?$customerinfo->customer_name:null) ?>" required>
        </div>
    </div>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-8">
            <input type="text" name="mobile" class="form-control" id="phone" placeholder="+8801712121212" value="<?php echo (!empty($customerinfo->customer_phone)?$customerinfo->customer_phone:$contactno) ?>" required>
        </div>
    </div>
    ...
    <div class="form-group row mb-2">
        ...
        <div class="col-sm-8">
            <input type="email" name="email" class="form-control" id="mail" placeholder="john@example.com" value="<?php echo (!empty($customerinfo->customer_email)?$customerinfo->customer_email:null) ?>">
        </div>
    </div>

    <div class="form-group row mb-2">
        <label for="message"  class="col-sm-4 col-form-label"><?php echo display('message') ?></label>
        <div class="col-sm-8">
